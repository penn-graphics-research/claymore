...
// init models
void init_models(std::array<std::vector<std::array<float, mn::config::NUM_DIMENSIONS>>, mn::config::G_DEVICE_CNT> models, int opt = 0) {
...
int main() {
	...
	std::array<std::vector<std::array<float, mn::config::NUM_DIMENSIONS>>, mn::config::G_DEVICE_CNT> models;
